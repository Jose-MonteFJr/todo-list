...
import com.todo.list.model.TaskModel;
...
public class TaskModelImpl extends BaseModelImpl<Task> implements TaskModel {
	...
	public static final String TABLE_SQL_CREATE =
		"create table Todo_Task (taskId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,title VARCHAR(75) null,description VARCHAR(75) null,completed BOOLEAN,deleted BOOLEAN)";
	...
	public static final String ORDER_BY_SQL = " ORDER BY Todo_Task.taskId ASC";
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(
		com.liferay.todo.com.todo.list.service.util.ServiceProps.get(
			"lock.expiration.time.com.todo.list.model.Task"));
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put("deleted", Task::getDeleted);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"deleted", (BiConsumer<Task, Boolean>)Task::setDeleted);
	...
	public Task cloneWithOriginalValues() {
		...
		taskImpl.setCompleted(
			this.<Boolean>getColumnOriginalValue("completed"));
		taskImpl.setDeleted(this.<Boolean>getColumnOriginalValue("deleted"));
	...
	public CacheModel<Task> toCacheModel() {
		...
		taskCacheModel.deleted = isDeleted();
