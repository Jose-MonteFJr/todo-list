...
import com.todo.list.exception.NoSuchTaskException;
import com.todo.list.model.Task;
import com.todo.list.model.TaskTable;
import com.todo.list.model.impl.TaskImpl;
import com.todo.list.model.impl.TaskModelImpl;
import com.todo.list.service.persistence.TaskPersistence;
import com.todo.list.service.persistence.TaskUtil;
...
public class TaskPersistenceImpl
	 ...
	 */
	@Override
	public List<Task> findByG_U(long groupId, long userId) {
		return findByG_U(
	 ...
	 */
	@Override
	public List<Task> findByG_U(long groupId, long userId, int start, int end) {
	 ...
	 */
	@Override
	public Task findByG_U_First(
			long groupId, long userId,
			OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {

		Task task = fetchByG_U_First(groupId, userId, orderByComparator);
	 ...
	 */
	@Override
	public Task fetchByG_U_First(
		long groupId, long userId, OrderByComparator<Task> orderByComparator) {

		List<Task> list = findByG_U(groupId, userId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Task findByG_U_Last(
			long groupId, long userId,
			OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {

		Task task = fetchByG_U_Last(groupId, userId, orderByComparator);
	 ...
	 */
	@Override
	public Task[] findByG_U_PrevAndNext(
	...
	protected Task getByG_U_PrevAndNext(
	...
	private static final String _FINDER_COLUMN_G_U_USERID_2 = "task.userId = ?";
	...
	public List<Task> findByG_U_C(
		...
		return findByG_U_C(groupId, userId, completed, start, end, null);
	}
	...
	public List<Task> findByG_U_C(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_G_U_C_COMPLETED_2);
	 ...
	 */
	@Override
	public Task findByG_U_C_First(
			long groupId, long userId, boolean completed,
			OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {

		Task task = fetchByG_U_C_First(
	 ...
	 */
	@Override
	public Task fetchByG_U_C_First(
		long groupId, long userId, boolean completed,
		OrderByComparator<Task> orderByComparator) {

		List<Task> list = findByG_U_C(
	 ...
	 */
	@Override
	public Task findByG_U_C_Last(
			long groupId, long userId, boolean completed,
			OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {

		Task task = fetchByG_U_C_Last(
			groupId, userId, completed, orderByComparator);
	 ...
	 */
	@Override
	public Task fetchByG_U_C_Last(
		long groupId, long userId, boolean completed,
		OrderByComparator<Task> orderByComparator) {

		int count = countByG_U_C(groupId, userId, completed);
	 ...
	 */
	@Override
	public Task[] findByG_U_C_PrevAndNext(
	...
	protected Task getByG_U_C_PrevAndNext(
		Session session, Task task, long groupId, long userId,
	 ...
	 */
	@Override
	public void removeByG_U_C(long groupId, long userId, boolean completed) {
		for (Task task :
				findByG_U_C(
	 ...
	 */
	@Override
	public int countByG_U_C(long groupId, long userId, boolean completed) {
	...
	private static final String _FINDER_COLUMN_G_U_C_COMPLETED_2 =
		"task.completed = ?";
	 ...
	 */
	@Override
	public List<Task> findByG_U_D(long groupId, long userId, boolean deleted) {
		return findByG_U_D(
			groupId, userId, deleted, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	 ...
	 */
	@Override
	public List<Task> findByG_U_D(
		long groupId, long userId, boolean deleted, int start, int end) {

		return findByG_U_D(groupId, userId, deleted, start, end, null);
	}
	...
	public List<Task> findByG_U_D(
		...
		return findByG_U_D(
			groupId, userId, deleted, start, end, orderByComparator, true);
	}
	...
	public List<Task> findByG_U_D(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				...
				finderArgs = new Object[] {groupId, userId, deleted};
			}
		}
		else if (useFinderCache) {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_G_U_D_DELETED_2);
	 ...
	 */
	@Override
	public Task findByG_U_D_First(
			long groupId, long userId, boolean deleted,
			OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {

		Task task = fetchByG_U_D_First(
	 ...
	 */
	@Override
	public Task fetchByG_U_D_First(
		long groupId, long userId, boolean deleted,
		OrderByComparator<Task> orderByComparator) {

		List<Task> list = findByG_U_D(
			groupId, userId, deleted, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Task findByG_U_D_Last(
			long groupId, long userId, boolean deleted,
			OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {

		Task task = fetchByG_U_D_Last(
			groupId, userId, deleted, orderByComparator);
	 ...
	 */
	@Override
	public Task fetchByG_U_D_Last(
		long groupId, long userId, boolean deleted,
		OrderByComparator<Task> orderByComparator) {

		int count = countByG_U_D(groupId, userId, deleted);
		...
		List<Task> list = findByG_U_D(
			groupId, userId, deleted, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public Task[] findByG_U_D_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_U_D_PrevAndNext(
				session, task, groupId, userId, deleted, orderByComparator,
				true);
	...
	protected Task getByG_U_D_PrevAndNext(
		Session session, Task task, long groupId, long userId, boolean deleted,
		OrderByComparator<Task> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public void removeByG_U_D(long groupId, long userId, boolean deleted) {
		for (Task task :
				findByG_U_D(
					groupId, userId, deleted, QueryUtil.ALL_POS,
					QueryUtil.ALL_POS, null)) {
	 ...
	 */
	@Override
	public int countByG_U_D(long groupId, long userId, boolean deleted) {
		FinderPath finderPath = _finderPathCountByG_U_D;

		Object[] finderArgs = new Object[] {groupId, userId, deleted};
	...
	private static final String _FINDER_COLUMN_G_U_D_DELETED_2 =
		"task.deleted = ?";

	private FinderPath _finderPathWithPaginationFindByG_U_C_D;
	private FinderPath _finderPathWithoutPaginationFindByG_U_C_D;
	private FinderPath _finderPathCountByG_U_C_D;
	 ...
	 */
	@Override
	public List<Task> findByG_U_C_D(
		long groupId, long userId, boolean completed, boolean deleted) {

		return findByG_U_C_D(
			groupId, userId, completed, deleted, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<Task> findByG_U_C_D(
		...
		return findByG_U_C_D(
			groupId, userId, completed, deleted, start, end, null);
	}
	...
	public List<Task> findByG_U_C_D(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByG_U_C_D;
				finderArgs = new Object[] {groupId, userId, completed, deleted};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByG_U_C_D;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_G_U_C_D_GROUPID_2);

			sb.append(_FINDER_COLUMN_G_U_C_D_USERID_2);

			sb.append(_FINDER_COLUMN_G_U_C_D_COMPLETED_2);

			sb.append(_FINDER_COLUMN_G_U_C_D_DELETED_2);
	 ...
	 */
	@Override
	public Task findByG_U_C_D_First(
			long groupId, long userId, boolean completed, boolean deleted,
			OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {

		Task task = fetchByG_U_C_D_First(
	 ...
	 */
	@Override
	public Task fetchByG_U_C_D_First(
		long groupId, long userId, boolean completed, boolean deleted,
		OrderByComparator<Task> orderByComparator) {

		List<Task> list = findByG_U_C_D(
			groupId, userId, completed, deleted, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Task findByG_U_C_D_Last(
			long groupId, long userId, boolean completed, boolean deleted,
			OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {

		Task task = fetchByG_U_C_D_Last(
			groupId, userId, completed, deleted, orderByComparator);
	 ...
	 */
	@Override
	public Task fetchByG_U_C_D_Last(
		long groupId, long userId, boolean completed, boolean deleted,
		OrderByComparator<Task> orderByComparator) {

		int count = countByG_U_C_D(groupId, userId, completed, deleted);
		...
		List<Task> list = findByG_U_C_D(
			groupId, userId, completed, deleted, count - 1, count,
			orderByComparator);
	 ...
	 */
	@Override
	public Task[] findByG_U_C_D_PrevAndNext(
			long taskId, long groupId, long userId, boolean completed,
		...
		try {
			...
			array[0] = getByG_U_C_D_PrevAndNext(
				session, task, groupId, userId, completed, deleted,
				orderByComparator, true);

			array[1] = task;

			array[2] = getByG_U_C_D_PrevAndNext(
				session, task, groupId, userId, completed, deleted,
	...
	protected Task getByG_U_C_D_PrevAndNext(
		Session session, Task task, long groupId, long userId,
	 ...
	 */
	@Override
	public int countByG_U_C_D(
		long groupId, long userId, boolean completed, boolean deleted) {

		FinderPath finderPath = _finderPathCountByG_U_C_D;
	...
	private static final String _FINDER_COLUMN_G_U_C_D_GROUPID_2 =
		"task.groupId = ? AND ";

	private static final String _FINDER_COLUMN_G_U_C_D_USERID_2 =
		"task.userId = ? AND ";

	private static final String _FINDER_COLUMN_G_U_C_D_COMPLETED_2 =
		"task.completed = ? AND ";

	private static final String _FINDER_COLUMN_G_U_C_D_DELETED_2 =
		"task.deleted = ?";
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByG_U_D = new FinderPath(
			...
			new String[] {"groupId", "userId", "deleted"}, true);
		...
		_finderPathCountByG_U_D = new FinderPath(
			...
			new String[] {"groupId", "userId", "deleted"}, false);

		_finderPathWithPaginationFindByG_U_C_D = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_U_C_D",
			new String[] {
				Long.class.getName(), Long.class.getName(),
			...
			new String[] {"groupId", "userId", "completed", "deleted"}, true);

		_finderPathWithoutPaginationFindByG_U_C_D = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_U_C_D",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName(), Boolean.class.getName()
			},
		...
		_finderPathCountByG_U_C_D = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_U_C_D",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName(), Boolean.class.getName()
			},
			new String[] {"groupId", "userId", "completed", "deleted"}, false);
