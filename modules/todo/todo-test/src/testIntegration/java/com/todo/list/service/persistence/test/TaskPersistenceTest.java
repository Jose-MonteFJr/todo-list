...
import com.todo.list.service.TaskLocalServiceUtil;
...
public class TaskPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newTask.setDeleted(RandomTestUtil.randomBoolean());
		...
		Assert.assertEquals(existingTask.isDeleted(), newTask.isDeleted());
	}
	...
	public void testCountByG_U_C() throws Exception {
		...
		_persistence.countByG_U_C(0L, 0L, RandomTestUtil.randomBoolean());
	}
	...
	protected Task addTask() throws Exception {
		...
		task.setDeleted(RandomTestUtil.randomBoolean());
