 ...
 * <code>com.todo.list.service.impl.TaskLocalServiceImpl</code> and
...
public class TaskLocalServiceUtil {
	...
	public static List<Task> getTasksByStatus(
		...
		return getService().getTasksByStatus(groupId, userId, completed);
	}
	...
	public static Task updateTask(long taskId, String title, String description)
		throws PortalException {

		return getService().updateTask(taskId, title, description);
	}
