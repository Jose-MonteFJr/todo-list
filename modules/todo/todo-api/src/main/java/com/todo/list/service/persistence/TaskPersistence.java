...
public interface TaskPersistence extends BasePersistence<Task> {
	 ...
	 */
	public java.util.List<Task> findByG_U(long groupId, long userId);
	 ...
	 */
	public java.util.List<Task> findByG_U(
	 ...
	 * @return the matching tasks
	 */
	public java.util.List<Task> findByG_U_C(
	 ...
	 * @return the matching tasks
	 */
	public java.util.List<Task> findByG_U_D(
	 ...
	 * @return the matching tasks
	 */
	public java.util.List<Task> findByG_U_C_D(
