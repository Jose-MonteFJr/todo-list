...
/**
 * The persistence utility for the task service. This utility wraps <code>com.todo.list.service.persistence.impl.TaskPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TaskUtil {
	 ...
	 */
	public static List<Task> findByG_U(long groupId, long userId) {
	 ...
	 */
	public static List<Task> findByG_U(
	 ...
	 */
	public static Task findByG_U_First(
	 ...
	 */
	public static Task fetchByG_U_First(
	 ...
	 * @throws NoSuchTaskException if a matching task could not be found
	 */
	public static Task findByG_U_Last(
			long groupId, long userId,
			OrderByComparator<Task> orderByComparator)
		throws com.todo.list.exception.NoSuchTaskException {
	 ...
	 */
	public static Task fetchByG_U_Last(
		long groupId, long userId, OrderByComparator<Task> orderByComparator) {
	 ...
	 */
	public static Task[] findByG_U_PrevAndNext(
	 ...
	 * @return the matching tasks
	 */
	public static List<Task> findByG_U_C(
		long groupId, long userId, boolean completed) {

		return getPersistence().findByG_U_C(groupId, userId, completed);
	}
	 ...
	 * @throws NoSuchTaskException if a matching task could not be found
	 */
	public static Task findByG_U_C_First(
			long groupId, long userId, boolean completed,
			OrderByComparator<Task> orderByComparator)
		throws com.todo.list.exception.NoSuchTaskException {
	 ...
	 * @return the first matching task, or <code>null</code> if a matching task could not be found
	 */
	public static Task fetchByG_U_C_First(
		long groupId, long userId, boolean completed,
		OrderByComparator<Task> orderByComparator) {
	 ...
	 * @throws NoSuchTaskException if a matching task could not be found
	 */
	public static Task findByG_U_C_Last(
			long groupId, long userId, boolean completed,
			OrderByComparator<Task> orderByComparator)
		throws com.todo.list.exception.NoSuchTaskException {
	 ...
	 * @return the last matching task, or <code>null</code> if a matching task could not be found
	 */
	public static Task fetchByG_U_C_Last(
		long groupId, long userId, boolean completed,
		OrderByComparator<Task> orderByComparator) {
	 ...
	 * @throws NoSuchTaskException if a task with the primary key could not be found
	 */
	public static Task[] findByG_U_C_PrevAndNext(
	...
	public static void removeByG_U_C(
		...
		getPersistence().removeByG_U_C(groupId, userId, completed);
	}
	...
	public static int countByG_U_C(
		...
		return getPersistence().countByG_U_C(groupId, userId, completed);
	}
