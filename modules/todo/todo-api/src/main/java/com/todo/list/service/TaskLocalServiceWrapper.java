...
public class TaskLocalServiceWrapper
	 ...
	 */
	@Override
	public com.todo.list.model.Task addTask(com.todo.list.model.Task task) {
	 ...
	 */
	@Override
	public com.todo.list.model.Task createTask(long taskId) {
	 ...
	 */
	@Override
	public com.todo.list.model.Task deleteTask(long taskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public com.todo.list.model.Task deleteTask(com.todo.list.model.Task task) {
	...
	@Override
	public com.todo.list.model.Task fetchTask(long taskId) {
	 ...
	 */
	@Override
	public com.todo.list.model.Task getTask(long taskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.todo.list.model.Task> getTasks(
		int start, int end) {
	...
	public java.util.List<com.todo.list.model.Task> getTasksByStatus(
		...
		return _taskLocalService.getTasksByStatus(groupId, userId, completed);
	}
	 ...
	 */
	@Override
	public com.todo.list.model.Task updateTask(com.todo.list.model.Task task) {
